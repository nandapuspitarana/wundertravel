...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => esc_html__( 'Custom Metabox Wunder Travel', 'cmb2' ),
		'object_types'  => array( 'destinations' ), // Post type
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Destination Page Slogan', 'cmb2' ),
		'desc' => esc_html__( "(e.g: Enjoy Bali's authentic atmosphere...)", 'cmb2' ),
